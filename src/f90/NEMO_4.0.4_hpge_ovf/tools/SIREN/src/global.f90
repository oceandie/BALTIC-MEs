...
MODULE global
   ...
   CHARACTER(LEN=lc)                       , PARAMETER :: cp_url="$URL: svn+ssh://dbruciaferri@forge.ipsl.jussieu.fr/ipsl/forge/projets/nemo/svn/utils/tools_r4.0-HEAD/SIREN/src/global.f90 $"    !< svn url
