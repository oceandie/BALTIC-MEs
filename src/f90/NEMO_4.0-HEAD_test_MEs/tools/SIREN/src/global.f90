...
MODULE global
   ...
   CHARACTER(LEN=lc)                       , PARAMETER :: cp_url="$URL: svn+ssh://dbruciaferri@forge.ipsl.jussieu.fr/ipsl/forge/projets/nemo/svn/NEMO/branches/UKMO/tools_r4.0-HEAD_dev_MEs/SIREN/src/global.f90 $"    !< svn url
